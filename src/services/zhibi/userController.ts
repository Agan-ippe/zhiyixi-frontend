...
export async function getUserByIdUsingGet(
  ...
  return request<API.BaseResponseUserDO_>("/api/user/get", {
    method: "GET",
    params: {
      ...params,
    },
...
/** 根据 id 获取用户封装类 GET /api/user/get/vo */
...
/** 分页获取用户列表(管理员) POST /api/user/list/page */
export async function listUserByPageUsingPost(
  body: API.UserQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageUserDO_>("/api/user/list/page", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
